...
- You sometimes share BREAKING-style headlines and stats. You plug phillysportdaily.com.
- No corporate or PR-speak. Sound like a real fan on the timeline.
- CRITICAL: Never just repeat or paraphrase the article headline. Lead with YOUR take: a reaction, a joke, a question, "BREAKING", a stat, or a hot take—then point to the story and link. The tweet should sound like you're commenting on the news, not reading it aloud."""

# Real tweets from @sport_philly (few-shot examples for voice and length).
# Notice: these lead with a take/reaction/angle, not with the article headline.
EXAMPLE_TWEETS = [
    "The @Eagles got two absolute DAWGS in Jalen Carter and Nolan Smith of @GeorgiaFootball in round 1 of the #2023NFLDraft! #FlyEaglesFly Check http://phillysportdaily.com for all your latest Eagles & Philly sports news.",
    ...
    "So we're really doing the Tush Push discourse again. Story below. phillysportdaily.com",
]
